  ...
  var TRANSLATIONS = {
    de: {
      ...
      home: {
        ...
        news: {
          title: 'Neuigkeiten',
          subtitle: 'Berichte, Rennen und Vereinsleben.',
      ...
      blog: {
        loading: 'Lade Beitrag...',
        notFound: 'Beitrag nicht gefunden.',
        breadcrumbHome: 'Startseite',
        breadcrumbSection: 'Neuigkeiten',
        readingTime: 'Lesedauer: {minutes} Min.',
    ...
    en: {
      ...
      home: {
        ...
        news: {
          title: 'News',
          subtitle: 'Stories, races and club life.',
          readMore: 'Read more',
    ...
    pl: {
      ...
      home: {
        ...
        news: {
          title: 'Aktualności',
          subtitle: 'Relacje, regaty i życie klubowe.',
      ...
      blog: {
        ...
        breadcrumbSection: 'Aktualności',
        readingTime: 'Czas czytania: {minutes} min',
        publishedOn: 'Opublikowano {date}',
        author: 'Autor: {author}',
        backHome: '← Powrót do strony głównej',
        toCalendar: 'Do kalendarza',
      },
    },
    nl: {
      ...
      home: {
        ...
        news: {
          title: 'Nieuws',
          subtitle: 'Verhalen, races en clubleven.',
          readMore: 'Lees meer',
      ...
      blog: {
        ...
        breadcrumbHome: 'Home',
        breadcrumbSection: 'Nieuws',
        readingTime: 'Leestijd: {minutes} min',
        publishedOn: 'Gepubliceerd op {date}',
        author: 'Auteur: {author}',
        backHome: '← Terug naar home',
        toCalendar: 'Naar kalender',
      },
    },
  };
